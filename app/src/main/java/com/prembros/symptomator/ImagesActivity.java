...
public class ImagesActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("upload").child(signhome.nowusing);
    ...
    */
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ImagesActivity.this, "Couldn't Delete Item", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (list.isEmpty())
            {
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(ImagesActivity.this, "DownloadChannel")
                ...
                Toast.makeText(ImagesActivity.this, "Downloads Successful", Toast.LENGTH_SHORT).show();
